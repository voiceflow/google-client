...
import RuntimeClientManager from '@/lib/services/dialogflow/lifecycle/es/runtime';

describe('runtimeClientManagerDialogflowES unit tests', async () => {
  describe('build', () => {
    it('works', async () => {
      ...
      const services = {
        ...
        runtimeClientDialogflowES: client,
      };
